...
{
    $dataArr = [];
    $dataArr['name'] = $employee->getElementsByTagName('name')->item(0)->nodeValue;
    $dataArr['address'] = $employee->getElementsByTagName('address')->item(0)->nodeValue;
    $dataArr['email'] = $employee->getElementsByTagName('email')->item(0)->nodeValue;
    $dataArr['phone'] = $employee->getElementsByTagName('phone')->item(0)->nodeValue;
